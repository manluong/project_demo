				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
						<div class="form-group">
							<label class="control-label col-md-3">Join<span class="required" aria-required="true">*</span></label>
							<div class="col-md-9">
								<input name="join" id="join" class="form-control" rows="10" value="<?php echo (!empty($result->join) ? $result->join : '')?>"/>
							</div>
						</div>
					</div>
