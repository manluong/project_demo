                        ...
                        <div class="step-3">                       
                            <div class="fields">
                                <p>
                                    ...
                                    <input id="oldpass" type="password" name="old-password" placeholder="Please enter your current password">
                                </p>
                                <p>
                                    <label>New Password *</label>
                                    <input id="pass" type="password" name="old-password" class=" check-strong-password">
                                    <ul class="display-suggestion hide">
                                        <li id="length">Password must be minimum 8 & maximum 12 characters in length</li>
