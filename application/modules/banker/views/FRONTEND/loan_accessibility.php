		...
		<table>
			<thead>
				...
				<tr>
					...
					<td class="center-text"><?=(!empty($v->batch_no)?$this->student_model->getPimName($v->batch_no):'')?></td>			
					<td><a href="<?=PATH_URL.'banker/loan_accessibility_list/'.$v->student_id?>">View</a></td>
				</tr>
				<?php }}?>
		</table>
