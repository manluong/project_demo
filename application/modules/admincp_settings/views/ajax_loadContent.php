							...
							<table class="table table-striped table-bordered table-hover dataTable no-footer">
								<thead>
									...
									<!-- 	<th class="sorting" onclick="sort('username')" id="username">Options</th> -->
										<th class="center sorting" onclick="sort('slug')" id="slug" width="100">Slug</th>
										<th class="center sorting" width="60" onclick="sort('content')" id="content">Content</th>
								...
								<tbody>
									...
									<tr class="item_row<?=$i?> gradeX <?php ($k%2==0) ? print 'odd' : print 'even' ?>" role="row">
										...
										<td><a href="<?=PATH_URL_ADMIN.$module.'/update/'.$v->id?>"><?=$v->slug?></a></td>
										<td class="center">
											<?=htmlentities($v->content)?>
										</td>
