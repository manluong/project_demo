				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-3">Function <span class="required" aria-required="true">*</span></label>
							<div class="col-md-9"><input value="<?php echo (!empty($result->function) ? $result->function : '') ?>" type="text" name="function" id="function" class="form-control" placeholder="Enter function..." required /></div>
						</div>
					</div>
